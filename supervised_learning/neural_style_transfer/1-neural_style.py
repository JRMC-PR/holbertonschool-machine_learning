...
class NST:
    ...
    def laod_model(self):
        ...
        """
        # Initialize VGG19 as the base model, excluding the top layer (classifier)
        ...
        base_vgg = tf.keras.applications.VGG19(include_top=False,
                                            ...
                                            pooling=None,
                                            classes=1000)
        # Modify the model by substituting MaxPooling with AveragePooling
        # Achieved by utilizing the custom_objects parameter during model loading
        # This modification can enhance the quality of features extracted for NST
        ...
        # Instead, set each layer's trainable attribute to False to lock weights
        # Prevents the alteration of pre-trained weights during the NST process
        ...
        # Merge style and content layer outputs for comprehensive feature representation
        # This concatenated output facilitates simultaneous style and content optimization
        outputs = style_outputs + [content_output]
        # Construct a new model tailored for NST by specifying desired inputs and outputs
        # This custom model is central to the NST algorithm, enabling feature extraction
