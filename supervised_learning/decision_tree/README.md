...
---
## 1-Number of nodes in a decision tree
...
---
We now want to count the number of nodes in a decision tree, potentially excluding the root and internal nodes to count only the leaves. In order to do so, we added a method def count_nodes(self, only_leaves=False): in the Decision_Treeclass:
---
