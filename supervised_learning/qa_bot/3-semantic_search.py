...
def encode_texts(texts, tokenizer, model):
    ...
    embeddings = outputs.last_hidden_state[:, 0, :].numpy()  # Use the [CLS] token embedding
    return embeddings
...
def semantic_search(corpus_path, sentence):
    ...
    :param corpus_path: str, path to the corpus of reference documents
    :param sentence: str, sentence from which to perform semantic search
    :return: str, containing the reference text of the document most similar to the sentence
    """
