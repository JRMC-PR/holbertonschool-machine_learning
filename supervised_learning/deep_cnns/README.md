...
__________________________________________________________________________________________________
ubuntu@alexa-ml:~/supervised_learning/deep_cnns$Repo:GitHub repository:holbertonschool-machine_learningDirectory:supervised_learning/deep_cnnsFile:7-densenet121.pyHelp×Students who are done with "7. DenseNet-121"Review your work×Correction of "7. DenseNet-121"Congratulations!All tests passed successfully!You are ready for your next mission!Start a new testCloseResult:File existsFirst line contains#!/usr/bin/env python3Not allowed to import any module exceptfrom tensorflow import keras as K,dense_block = __import__('5-dense_block').dense_blockandtransition_layer = __import__('6-transition_layer').transition_layerOutput check: model summary is correctOutput check: activations are correctOutput check: conv layer initializations are correctPycodestyle validationEverything is documentedRequirement successRequirement failCode successCode failEfficiency successEfficiency failText answer successText answer failSkipped - Previous check failedQA Review×7. DenseNet-121Commit used:User:---URL:Click hereID:---Author:---Subject:---Date:---8/8pts

**Repository:**
- GitHub repository: `holbertonschool-machine_learning`
- Directory: `supervised_learning/classification`
- File: `Deep_Convolutional_Architectures.md`
