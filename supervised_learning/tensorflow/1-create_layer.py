...
def create_layer(prev, n, activation):
    """
    Creates a fully connected layer in a neural network with He et. al initialization.
    ...
    Returns:
    layer: Tensor. The output of the layer after applying weights, biases, and activation function.
    """
    # Define the initializer for the weights using He et. al initialization
    initializer = tf.keras.initializers.VarianceScaling(mode='fan_avg')

    # Define weights for the current layer
    # Weights are a 2D tensor with shape [prev.shape[1], n], initialized with the defined initializer
    ...
    # This is done using matrix multiplication between the output of the previous layer and the weights,
