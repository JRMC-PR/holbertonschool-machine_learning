...
# base_model = K.applications.EfficientNetB7(include_top=False, weights='imagenet',
#                                         input_shape=(224, 224, 3))

# # Add a lambda layer to scale up the image size
# model = K.models.Sequential()
# model.add(K.layers.Lambda(lambda image: K.backend.resize_images(
#     image, 7, 7, "channels_last"), input_shape=(32, 32, 3)))
...
# Second try using resnet50

# """This module trains a CNN to classify CIFAR10 data set
