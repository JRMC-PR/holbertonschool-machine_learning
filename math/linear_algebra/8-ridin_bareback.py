...
def mat_mul(mat1, mat2):
    ...
    Returns:
    - List[List[int/float]]: A new matrix (list of lists) representing the product of mat1 and mat2. If the number of columns in mat1 is
    not equal to the number of rows in mat2, returns None.

    Note:
    The function assumes that the input matrices are compatible for multiplication, i.e., the number of columns in the first matrix (mat1)
    is equal to the number of rows in the second matrix (mat2).
    """
